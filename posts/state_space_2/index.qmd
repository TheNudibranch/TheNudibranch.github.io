...
[Stan](https://mc-stan.org/) is a probabilistic programming language built for Bayesian inference. It allows us to define our model in terms of priors, likelihoods, and generative structure without having to worry about specific maximum likelihood algorithms. We just let Stan turn the Bayesian crank to perform inference. 
...
#| code-fold: true
#| fig-align: center
#| code-summary: "Generate T matrix"
...
#| code-fold: true
#| fig-align: center
#| code-summary: "Generate R matrix"
